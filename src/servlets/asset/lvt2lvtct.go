...
// sendVCodeHandler
type lvt2lvtcHandler struct {
	//header      *common.HeaderParams // request header param
	//requestData *sendVCodeRequest    // request body
}

func (handler *lvt2lvtcHandler) Method() string {
	return http.MethodPost
}

func (handler *lvt2lvtcHandler) Handle(request *http.Request, writer http.ResponseWriter) {
